...
build_qc_args() {
    ...
    local entries=(
        ...
        "eddy-json|${outputdir}/dwi-preproc/${subj}${sessionpath}dwi/eddyqc/qc.json"
        ...
        "eddy-cnr-maps|${outputdir}/dwi-preproc/${subj}${sessionpath}dwi/${subj}${sessionfile}space-dwi_label-cnr-maps_desc-preproc_dwi.nii.gz"
        ...
        "response-voxels|${outputdir}/dwi-connectome/${subj}${sessionpath}qc/${subj}${sessionfile}space-dwi_desc-response_voxels.nii.gz"
        "response-underlay|${outputdir}/dwi-preproc/${subj}${sessionpath}dwi/${subj}${sessionfile}space-dwi_desc-nodif-brain_dwi.nii.gz"
        "tract-tck|${outputdir}/dwi-connectome/${subj}${sessionpath}qc/${subj}${sessionfile}space-dwi_tracto-100k.tck"
        "connectivity-matrix|${outputdir}/dwi-connectome/${subj}${sessionpath}conn/${subj}${sessionfile}atlas-${atlas}_desc-streams_connmatrix.csv"
    )
